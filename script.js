let questions = [
  ...
  {
    question:
      "Welches Betriebssystem ist das beliebteste Betriebssystem der Welt",
    answer_1: "macOS",
    answer_2: "Linux",
    answer_3: "Windows",
    answer_4: "Android",
  ...
  },
  {
    ...
    answer_2:
      "Ein Framework bietet Entwicklern eine Struktur für die Erstellung von Programmen.",
  ...
  {
    question:
      "Wie heißt die Software, die für die Steuerung eines Computers zuständig ist?",
...
function answer(selection) {
  ...
  if (rightAnswerSelected(selectedQuestionNumber, question)) {
    ...
    document
      .getElementById(ifOfRightAnswer)
...
function showEndScreen() {
  ...
  document.getElementById("question_amount_result").innerHTML =
    questions.length;
  document.getElementById("amount_of_right_questions").innerHTML =
    rightQuestions;
